...
document
  ...
  .addEventListener("click", function () {
    ...
    const data_nasc = document.getElementById("cadastrodatanasc").value.trim();
...
async function fetchCliente() {
  try {
    ...
    document.getElementById("atualizaTelefone").value =
      data.result[0].telefone || "";
    ...
    document.getElementById("atualizadatanasc").value =
      data.result[0].data_nasc || "";
